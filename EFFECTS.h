...
class EFFECTS
{
	...
	std::vector<short int> SIDECHAIN(std::vector<short int> audioData, double BPM, int sampleRate); //applies a sidechain to audio/ truncates values according to a periodic function
